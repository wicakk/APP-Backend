...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Manajemen Lembur</h2>
            <p class="text-sm text-gray-500">Kelola pengajuan lembur pegawai</p>
        </div>
    </div>
    ...
    <div class="bg-white shadow-sm rounded-xl overflow-hidden">
        ...
        <div class="px-6 py-4 border-b">
            <h3 class="font-semibold text-gray-700">Pengajuan Lembur</h3>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200" id="example">
                ...
                <thead class="bg-gray-50">
                    <tr class="text-left text-sm font-semibold text-gray-600">
                        ...
                        <th class="px-6 py-3">Tanggal Lembur</th>
                        <th class="px-6 py-3">Jam Mulai</th>
                        <th class="px-6 py-3">Jam Selesai</th>
                        <th class="px-6 py-3">Total Jam</th>
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-gray-600">
                            {{ \Carbon\Carbon::parse($item->tanggal_lembur)->format('d M Y') }}
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                <form action="{{ route('lembur.setujui', $item->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
...
<div id="modalCatatan" class="hidden fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
    <div class="bg-white rounded-xl w-96 p-6">
        ...
        <div class="flex justify-end">
            <button type="button" onclick="tutupModalCatatan()"
                class="px-4 py-2 bg-gray-200 rounded-lg">
                Tutup
            </button>
        </div>
...
<script>
    function konfirmasiTolak(id) {
        document.getElementById("formTolak").action = "{{ url('lembur/tolak') }}/" + id;
