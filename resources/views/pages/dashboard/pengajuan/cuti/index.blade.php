...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500">Kelola pengajuan cuti dan izin pegawai</p>
        </div>
    </div>
...
{{-- MODAL TOLAK --}}
<div id="modalTolak" class="hidden fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center">
