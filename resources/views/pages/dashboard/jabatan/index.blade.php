    ...
    <div class="max-w-8xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-10">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">
                    Kelola jabatan di perusahaan dengan mudah
                </p>
            </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <form action="{{ route('jabatan.destroy', $item->id) }}" method="POST"
                          onsubmit="return confirm('Yakin ingin menghapus jabatan {{ $item->nama_jabatan }}?')">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
            ...
            <div class="col-span-full rounded-2xl bg-blue-500 dark:bg-gray-700 text-center py-20">
                ...
                <a href="{{ route('jabatan.create') }}"
                   class="inline-block bg-gray-400 hover:bg-gray-700 text-white px-6 py-2.5 rounded-xl shadow-md transition">
