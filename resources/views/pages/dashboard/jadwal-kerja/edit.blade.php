...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 transition-colors duration-300">
    <div class="max-w-xl mx-auto">
        ...
        {{-- Header --}}
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Jadwal</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui jadwal kerja</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            <form action="{{ route('jadwal.update', $jadwal->id) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="time" name="jam_masuk" value="{{ $jadwal->jam_masuk }}"
                           class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <input type="time" name="jam_pulang" value="{{ $jadwal->jam_pulang }}"
                           class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <input type="text" name="durasi" value="{{ $jadwal->durasi }}" placeholder="cth: 9 Jam"
                           class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
