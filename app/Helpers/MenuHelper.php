    ...
    public static function getMainNavItems()
    {
        return [
            ...
            [
                ...
                'icon' => 'Absensi',
                'subItems' => [
                    ['name' => 'Rekap Absensi','path' => '/rekapabsensi', 'pro' => false],
                    ['name' => 'Jadwal Kerja','path' => '/jadwal', 'pro' => false],
                    ],
            ],
            [
                'name' => 'Informasi',
                'icon' => 'Absensi',
                'subItems' => [
                    ['name' => 'User Pegawai','path' => '/pegawai', 'pro' => false],
                    ['name' => 'Departemen','path' => '/departemen', 'pro' => false],
                    ['name' => 'Jabatan','path' => '/jabatan', 'pro' => false],
                    ['name' => 'Pengumuman','path' => '/pengumuman', 'pro' => false],
                ],
            ],
            [
                'name' => 'Pengajuan ',
                'icon' => 'Absensi',
                'subItems' => [
                    ['name' => 'Pengajuan Cuti','path' => '/cuti', 'pro' => false],
                    ['name' => 'Pengajuan Absen','path' => '/pengajuan-absensi', 'pro' => false],
                    ['name' => 'Pengajuan Perubahan Data','path' => '/perubahan-pegawai', 'pro' => false],
                    ['name' => 'Pengajuan Lembur','path' => '/lembur', 'pro' => false],
